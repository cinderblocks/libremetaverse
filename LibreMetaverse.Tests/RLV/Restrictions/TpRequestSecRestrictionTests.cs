...
{
    [TestFixture]
    public class TpRequestSecRestrictionTests : RlvTestBase
    {
        ...
        public async Task CanTpRequest_Secure_Default()
        {
            ...
            await _rlv.ProcessMessageAsync("@tprequest_sec=n", _sender.Id, _sender.Name);
        ...
        public async Task CanTpRequest_Secure()
        {
            ...
            await _rlv.ProcessMessageAsync($"@tprequest:{userId2}=add", sender2.Id, sender2.Name);
