...
namespace LibreMetaverse.Tests.RLV.Restrictions
{
    ...
    public class SitTpRestrictionTests : RlvTestBase
    {
        ...
        {
            await _rlv.ProcessMessageAsync("@SitTp:2.5=n", _sender.Id, _sender.Name);
        ...
        {
            await _rlv.ProcessMessageAsync("@SitTp:3.5=n", _sender.Id, _sender.Name);
            await _rlv.ProcessMessageAsync("@SitTp:4.5=n", _sender.Id, _sender.Name);
            await _rlv.ProcessMessageAsync("@SitTp:2.5=n", _sender.Id, _sender.Name);
        ...
        public async Task CanSitTp_Multiple_SingleSender_WithRemoval()
        {
            ...
            await _rlv.ProcessMessageAsync("@SitTp:8.5=n", _sender.Id, _sender.Name);
            await _rlv.ProcessMessageAsync("@SitTp:8.5=y", _sender.Id, _sender.Name);
        ...
        public async Task CanSitTp_Multiple_MultipleSenders()
        {
            ...
            await _rlv.ProcessMessageAsync("@SitTp:3.5=n", _sender.Id, _sender.Name);
            await _rlv.ProcessMessageAsync("@SitTp:4.5=n", sender2.Id, sender2.Name);
            await _rlv.ProcessMessageAsync("@SitTp:2.5=n", sender3.Id, sender3.Name);
        ...
        {
            await _rlv.ProcessMessageAsync("@SitTp:2.5=n", _sender.Id, _sender.Name);
            await _rlv.ProcessMessageAsync("@SitTp:2.5=y", _sender.Id, _sender.Name);
