...
namespace LibreMetaverse.Tests.RLV.Restrictions
{
    ...
    public class TouchAttachOtherRestrictionTests : RlvTestBase
    {
        ...
        public async Task TouchAttachOther_default()
        {
            ...
            await _rlv.ProcessMessageAsync("@touchattachother=n", _sender.Id, _sender.Name);
        ...
        public async Task TouchAttachOther_Specific()
        {
            ...
            await _rlv.ProcessMessageAsync($"@touchattachother:{userId2}=n", _sender.Id, _sender.Name);
