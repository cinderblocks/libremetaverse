...
{
    [TestFixture]
    public class TouchMeExceptionTests : RlvTestBase
    {
        ...
        public async Task TouchMe_default()
        {
            ...
            await _rlv.ProcessMessageAsync("@touchme=add", _sender.Id, _sender.Name);
            ...
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.AttachedSelf, _sender.Id, null, null), Is.True);
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.AttachedOther, _sender.Id, userId1, null), Is.True);
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.RezzedInWorld, _sender.Id, null, 5.0f), Is.True);
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.Hud, _sender.Id, null, null), Is.True);
        }
