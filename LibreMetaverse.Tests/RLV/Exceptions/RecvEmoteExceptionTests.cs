...
{
    [TestFixture]
    public class RecvEmoteExceptionTests : RlvTestBase
    {
        ...
        public async Task CanRecvChat_RecvEmote_Except()
        {
            ...
            await _rlv.ProcessMessageAsync($"@recvemote:{userId1}=add", _sender.Id, _sender.Name);
            ...
            Assert.That(_rlv.Permissions.CanReceiveChat("/me says Hello world", userId2), Is.False);
        }
