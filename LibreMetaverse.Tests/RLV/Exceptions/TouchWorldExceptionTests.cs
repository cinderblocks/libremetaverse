...
{
    [TestFixture]
    public class TouchWorldExceptionTests : RlvTestBase
    {
        ...
        public async Task TouchWorld_Exception()
        {
            ...
            await _rlv.ProcessMessageAsync("@touchworld=n", _sender.Id, _sender.Name);
            await _rlv.ProcessMessageAsync($"@touchworld:{objectId2}=add", _sender.Id, _sender.Name);
            ...
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.AttachedSelf, objectId2, null, null), Is.True);
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.AttachedOther, objectId2, userId1, null), Is.True);
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.RezzedInWorld, objectId2, null, 5.0f), Is.True);
            Assert.That(_rlv.Permissions.CanTouch(RlvPermissionsService.TouchLocation.Hud, objectId2, null, null), Is.True);
        }
