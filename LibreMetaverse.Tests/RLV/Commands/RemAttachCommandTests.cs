...
{
    [TestFixture]
    public class RemAttachCommandTests : RlvTestBase
    {
        #region @detach @remattach[:<folder|attachpt|uuid>]=force
        [TestCase("@detach=force")]
        [TestCase("@remattach=force")]
        ...
        [TestCase("@detach:Clothing/Hats=force")]
        [TestCase("@remattach:Clothing/Hats=force")]
        ...
        [TestCase("@detach:Clothing/nostrip Hats=force")]
        [TestCase("@remattach:Clothing/nostrip Hats=force")]
        ...
        [TestCase("@detach:chest=force")]
        [TestCase("@remattach:chest=force")]
        ...
        [TestCase("@detach:skull=force")]
        [TestCase("@remattach:skull=force")]
        ...
        public async Task RemAttach_ByUUID_WithRestrictions(string command)
        {
            ...
            await _rlv.ProcessMessageAsync($"@detachallthis:{sampleTree.Clothing_Folder.Name}=n", _sender.Id, _sender.Name);
        ...
        public async Task RemAttach_ByUUID_External(string command)
        {
            ...
            // Act
            await _rlv.ProcessMessageAsync($"@{command}:{externalAttachable.AttachedPrimId}=force", _sender.Id, _sender.Name);
