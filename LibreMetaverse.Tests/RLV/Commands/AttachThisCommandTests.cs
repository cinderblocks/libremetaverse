...
{
    [TestFixture]
    public class AttachThisCommandTests : RlvTestBase
    {
        #region @attachthisoverorreplace @attachthisover @attachthis[:<attachpt> or <clothing_layer> or <uuid>]=force
        [TestCase("attachthis", true)]
        [TestCase("attachthisoverorreplace", true)]
        [TestCase("attachthisover", false)]
        ...
        [TestCase("attachthis")]
        [TestCase("attachthisoverorreplace")]
        [TestCase("attachthisover")]
